...
```
cd existing_repo
git remote add origin https://gitlab.ecole.ensicaen.fr/pnguyen/jeu-oie-ensicaen.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.ecole.ensicaen.fr/pnguyen/jeu-oie-ensicaen/-/settings/integrations)
